# Got Code from https://github.com/fxia22/pointnet.pytorch/blob/master/pointnet/model.py
...
class PointNetfeat(nn.Module):
    def __init__(self, global_feat = True, feature_transform = False):
        ...
        self.stn = STNkd(k=6)
        self.conv1 = torch.nn.Conv1d(6, 64, 1, bias = False)
        self.conv2 = torch.nn.Conv1d(64, 128, 1, bias = False)
        self.conv3 = torch.nn.Conv1d(128, 256, 1, bias = False)
        self.bn1 = nn.BatchNorm1d(64)
        self.bn2 = nn.BatchNorm1d(128)
